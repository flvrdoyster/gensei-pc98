...
|--------|------|----------:|----------:|------|
| 환세풍광전 (幻世風狂伝, 1994) | `hukyou` | 2,653 | 23,234 | 완료 |
| 환세희담 (幻世喜譚, 1995) | `kitan` | 7,661 | 75,531 | 완료 |
| 환세쾌도전 (幻世快盗伝, 1995) | `kaitou` | 6,276 | 54,817 | 완료 |
| 환세포물장 (幻世捕物帳, 1996) | `torimono` | 13,932 | 127,185 | 완료 |

번역 대상이었던 텍스트의 분량으로, 4타이틀 모두 완료된 시점의 확정치다
(`tag: ignore`로 의도적으로 원문을 남긴 줄은 제외).
...
```bash
# 4. 번역 검수 lint (미번역·잘림·깨진문자·일관성 — 4타이틀 공통, offset 정합은 쾌도전만)
...
**게임 내 한글 폰트**: [도깨비DNR고딕 Regular](https://github.com/flvrdoyster/font) by flvrdoyster  
