...
| 환세쾌도전 (幻世快盗伝, 1995) | `kaitou` | 텍스트 추출 완료 (~1891개, 구조 파싱 v5), 인서터 미구현 |
...
tools/
  ...
  kaitou_parser.py       쾌도전 텍스트 추출 v5 (6b/6d/simple 블록 파서 추가, 런 폴백 62 00 경계 제한)
...
translation/
  ...
  kaitou/translation.json   쾌도전 번역 파일 (641개 엔트리, 미번역)
